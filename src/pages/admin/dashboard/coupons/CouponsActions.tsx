...
import { updateCouponDetails, updateUpdatedCoupon } from "../../../../store/slices/adminSlices/adminCouponSlice";
...
const CouponsActions: React.FC<CouponsActionsProps> = ({ params, setData, selectedRowId,
  setRowId,
  setSelectedRowId,}) => {
  ...
  //   Swal.fire({
  //     title: "Are you sure?",
  //     text: `Do you want to delete ${row.couponCode} hotel!`,
  //     icon: "error",
  ...
  //       dispatch(deleteHotel({ couponData: row }));
