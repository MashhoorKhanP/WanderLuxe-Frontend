...
import { Avatar, Box, MenuItem, Select, Tooltip, Typography } from "@mui/material";
...
const Bookings: React.FC<BookingsProps> = ({ setSelectedLink, link }) => {
  ...
  const columns: GridColDef[] = useMemo(
    () => [
      ...
      { field: "numberOfNights", headerName: "Days", width: 60,align:'center' },
      {
        field: "status",
      ...
      { field: "totalAmount", headerName: "Amount",align:'center',renderCell: (params) => `₹${params.row.totalAmount}` },
