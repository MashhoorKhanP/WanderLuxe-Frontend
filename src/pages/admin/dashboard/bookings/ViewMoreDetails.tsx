...
const ViewMoreDetails: React.FC = () => {
  ...
  useEffect(() => {
    ...
    const roomData = rooms.find(
      (room: RoomDetails) => room._id === bookingData?.roomId
    );
    setRoom(roomData);
  }, [bookingId, bookings]);
              ...
              <Stack pb={1}>
                ...
                >
                  <Typography
                    ...
                    sx={{ fontSize: "14px" }}
                  >
                    {`Check-In: ${dayjs(bookingData?.checkInDate).format(
                      "ddd, MMM D, YYYY"
                  ...
                  <Typography
                    ...
                    sx={{ fontSize: "14px" }}
                  >
                    {`Check-Out: ${dayjs(bookingData?.checkOutDate).format(
                      "ddd, MMM D, YYYY"
                  ...
                  <Typography
                    ...
                    sx={{
                      ...
                      color:
                        ...
                        bookingData.status === "Cancelled by Admin"
                          ? "#DC3545"
                          : "#198754",
                      fontWeight: "bold",
                    }}
                  ...
                  <Typography
                    ...
                    sx={{ fontSize: "14px" }}
                  >
                    {`Booked on: ${dayjs(bookingData?.createdAt).format(
                      "ddd, MMM D, YYYY"
                    )}`}
                  </Typography>
                  <br />
              ...
              <Stack width={"100%"} direction="row">
                ...
                >
                  ...
                  <Typography
                    ...
                    sx={{ fontSize: "14px" }}
                  >
                    {`Room rent for ${bookingData?.numberOfNights} night x ${
                  ...
                  <Typography
                    ...
                    sx={{ fontSize: "14px" }}
                  >
                    {`Coupon Discount: -₹${bookingData.couponDiscount}`}
                  </Typography>
                  <br />
                  <Typography
                    variant="h6"
                    ...
                    sx={{ fontSize: "14px" }}
                  >
                    {`Coupon Id: ${bookingData.appliedCouponId}`}
                  </Typography>
                  <br />
                  <Typography
                    variant="h6"
