...
const AddHotel: React.FC = () => {
  ...
  useEffect(() => {
    if (
      hotelDetails.hotelName.length > 4 &&
      hotelDetails.location.length > 4 &&
      hotelDetails.distanceFromCityCenter &&
      hotelDetails.mobile.length > 9 &&
      hotelDetails.email.length > 9 &&
      hotelDetails.minimumRent &&
      hotelDetails.description.length > 14
    ) {
